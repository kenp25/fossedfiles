...
<div class="container">
    ...
    {{--<div class="col-lg-12 breadcrumb"><a href="/searches?q={{ $tag }}"><span data-toggle="tooltip" data-placement="top" title="Back" class="fui-arrow-left pull-left"></span></a><a data-toggle="tooltip" data-placement="top" title="Upload document" href="/upload"><span class="fui-plus pull-right"></span></a></div>--}}
        @if($systems->count())
            <div style="color: #5a5">Showing systems with the tag "{{ $tag }}"</div>
            <hr/>
                ...
                @endforeach
        @else
            <div>No results for the search term "{{ $tag }}"</div>
        @endif
