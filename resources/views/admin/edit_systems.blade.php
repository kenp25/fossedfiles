...
{{--        <div class="col-sm-3 col-md-2 sidebar">
    ...
    <h4 class="sub-header page-header">Edit System</h4>
    <div class="row">
        <div class="col-lg-6">
                @if ($errors->has())
            ...
            <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $systems->name }}"/>
                        </div>
                        <div class="form-group">
                            <label for="description">Description <span style="color: red">*</span></label>
                            {{--<input type="text" name="description" value="{{ $systems->description }}" class="form-control"/>--}}
                            <textarea class="form-control" name="description" value="">{{ $systems->description }}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="tag">Tag <span style="color: red">*</span></label>
                            <input type="text" name="tag" value="{{ $systems->tag }}" class="form-control"/>
                        </div>

                        <div class="form-group">
                            <label for="primary owner">Primary Owner <span style="color: red">*</span></label>
                            <input type="text" name="primary_owner" value="{{ $systems->primary_owner }}" class="form-control"/>
                        </div>


                        <div class="form-group">
                            <label for="secondary support">Secondary support <span style="color: red">*</span></label>
                            <input type="text" name="secondary_support" value="{{ $systems->secondary_support }}" class="form-control"/>
                        </div>

                        <button type="submit" class="btn btn-primary" name="submit">Update</button>
                        <a class="btn btn-danger" href="/admin/systems">Cancel</a>
                    </form>
        </div>
