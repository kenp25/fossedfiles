...
{{--        <div class="col-sm-3 col-md-2 sidebar">
    ...
    <h4 class="sub-header page-header">System Documents</h4>
    <div class="row">
        <div class="col-lg-2">
                                @if ($errors->has())
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ $system_docs->name }}"/>
                                    </div>

                                    <div class="form-group">
                                        <label for="description">Description <span style="color: red">*</span></label>
                                        {{--<input type="text" name="description" class="form-control" value="{{ $system_docs->description }}"/>--}}
                                        <textarea name="description" class="form-control">{{ $system_docs->description }}</textarea>
                                    </div>

                                    <button class="btn btn-success" type="submit">Update</button>
                                    <a class="btn btn-danger" href="/admin/docs">Cancel</a>
