                            ...
                            @if($systems->count())
                                @foreach($systems as $system)
                                    <tr>
                                        ...
                                        <td>{{ $system->tag }}</td>
                                        <td>{{ $system->primary_owner }}</td>
                                        <td>{{ $system->secondary_support }}</td>
                                        <td><a href="/admin/systems/edit/{{ $system->id }}">Edit</a></td>
                                        <td><a href="/admin/systems/delete/{{ $system->id }}">Delete</a></td>
                                    </tr>
                                @endforeach
