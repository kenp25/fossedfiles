...
{{--        <div class="col-sm-3 col-md-2 sidebar">
    ...
    <h4 class="sub-header page-header">Users<a data-toggle="tooltip" data-placement="top" title="Add User" href="/admin/users/add"><span class="fui-plus-circle pull-right"></span></a></h4>
                @if ($errors->has())
