...
{{--        <div class="col-sm-3 col-md-2 sidebar">
    ...
    <h4 class="sub-header page-header">Add System</h4>
    <div class="row">
        <div class="col-lg-6">
                                @if ($errors->has())
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="primary_owner">Primary Owner <span style="color: red">*</span></label>
                                        <input type="text" class="form-control" name="primary_owner"/>
                                    </div>

                                    <div class="form-group">
                                        <label for="secondary_Support">Secondary Support<span style="color: red">*</span></label>
                                        <input type="text" class="form-control" name="secondary_support"/>
                                    </div>
