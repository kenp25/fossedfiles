...
{{--        <div class="col-sm-3 col-md-2 sidebar">
    ...
    <h4 class="sub-header page-header">Edit Document Types</h4>
    <div class="row">
        <div class="col-lg-6">
                        @if ($errors->has())
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ $document_lists->name }}"/>
                            </div>

                            <div class="form-group">
                                <label for="description">Description <span style="color: red">*</span></label>
                               {{-- <input type="text" name="description" class="form-control" value="{{ $document_lists->description }}"/>--}}
                               <textarea class="form-control" name="description">{{ $document_lists->description }}</textarea>
                            </div>

                            <button class="btn btn-success" type="submit">Update</button>
                            <a class="btn btn-danger" href="/admin/types">Cancel</a>
