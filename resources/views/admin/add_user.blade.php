...
{{--        <div class="col-sm-3 col-md-2 sidebar">
    ...
    <h4 class="sub-header page-header">Add Users</h4>
    <div class="row">
        <div class="col-lg-6">
                    @if ($errors->has())
...
{{--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="confirming password">Confirm Password <span style="color: red">*</span></label>
                            <input type="password" class="form-control" name="password_confirmation"/>
                        </div>
                        <button type="submit" class="btn btn-primary" name="signup">Add</button>
