        ...
        <div class="table-responsive">
                        <table class="table table-bordered table-hovered table-striped">
                            ...
                            @if($system_documents->count())
                                @foreach($system_documents as $document)
                                    <tr>
                                        <td>{{ $document->name }}</td>
                                        ...
                                        <td><a href="/admin/docs/edit/{{ $document->id }}">Edit</a></td>
                                        <td><a href="/admin/docs/delete/{{ $document->id }}">Delete</a></td>
                                    </tr>
                                @endforeach
